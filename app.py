...
@app.route("/")
def index():
    return render_template("report_car_upload.html")
...
def report_get():
    return render_template("report_car.html")
...
def testing():
    ...
    if cropped_plate_img is False:
        ...
        return render_template("report_car_upload.html", status=valid_crop)
    ...
    return render_template("report_car.html", status=valid_crop, image_name=filename, car=car_type, processing=processing, result_img=result_plate_img, start_time_data=start_time_data, end_time_data=end_time_data)
